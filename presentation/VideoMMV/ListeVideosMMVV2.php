...
<head>
    ...
    <title>Liste de mes Videos MMV V2</title>
</head>
...
<div class="container">
    <section class="row">
        <div class="col-sm-12">
            <h1 class="text-center">Liste de mes Videos MMV V2</h1>
            <table class="table table-bordered table-striped ">
                <?php
                $nbVideos = 0;
                echo "<tr><th>IDVIDEOMMV</th> <th>TITRE VIDEO MMV</th><th>URL VIDEO MMV</th><th>DATE CREATION</th><th>SUJET VIDEO MMV</th>
                <th ><p class=\"fa fa-thumbs-up\"></p></th><th><p class=\"fa fa-thumbs-down\"></p></th><th>VUES</th><th>COUVERTURE VIDEO MMV</th><th>ID CHAINEY</th><th>NOM CHAINEY</th><th>URL CHAINEY</th>
                <th>SOUSCRIPTION CHAINEY</th></tr>";

                $listeVideo=$requeteListe->listerVideosMMV2();
                foreach ($listeVideo as $indice => $ligne) {
                    ...
                    $url_ChaineYoutube = $ligne['URLCHAINEY'];
                    $souscription_ChaineYoutube = $ligne['SOUSCRIPTIONY'];
                    ...
                    <td><p class='text-center'>$couverture</p><a href='../../images/couvertures/$couverture'><img   class='img-fluid ' src=\"../../images/couvertures/$couverture\"></a></td>
                    <td>$id_chaine_youtube</td><td>$nom_ChaineYoutube</td><td><a href='$url_ChaineYoutube'>$url_ChaineYoutube</a><td>$souscription_ChaineYoutube</td></tr>";
                    $nbVideos++;
                }
                ?>
            </table>
